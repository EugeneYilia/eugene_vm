...
pub fn ifeq(code_reader: &mut CodeReader, thread: &mut Thread) -> InstructionExecuteResult {
...
pub fn ifne(code_reader: &mut CodeReader, thread: &mut Thread) -> InstructionExecuteResult {
    // original_pc is current - instruction_op_code
    let original_pc = code_reader.pc - OP_CODE_LENGTH;
...
pub fn iflt(code_reader: &mut CodeReader, thread: &mut Thread) -> InstructionExecuteResult {
    // original_pc is current - instruction_op_code
    let original_pc = code_reader.pc - OP_CODE_LENGTH;
...
pub fn ifge(code_reader: &mut CodeReader, thread: &mut Thread) -> InstructionExecuteResult {
    // original_pc is current - instruction_op_code
    let original_pc = code_reader.pc - OP_CODE_LENGTH;
...
pub fn ifgt(code_reader: &mut CodeReader, thread: &mut Thread) -> InstructionExecuteResult {
    // original_pc is current - instruction_op_code
    let original_pc = code_reader.pc - OP_CODE_LENGTH;
...
pub fn ifle(code_reader: &mut CodeReader, thread: &mut Thread) -> InstructionExecuteResult {
    // original_pc is current - instruction_op_code
    let original_pc = code_reader.pc - OP_CODE_LENGTH;
